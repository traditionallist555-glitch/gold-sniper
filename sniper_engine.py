...
def generate_chart_image(df_15m, df_1m, setup_type, entry_price, sl_price, tp_price):
    """Renders 15M trend context and 1M execution entry levels safely."""
    ...
    try:
        ...
        ax1.set_title(f"XAUUSD 15M Trend Filter ({setup_type})", fontsize=11, fontweight='bold')
        ...
        ax2.set_title("1M Structure Execution", fontsize=9)
...
def scan():
    try:
        ...
        result = loop.run_until_complete(run_scan_logic())
